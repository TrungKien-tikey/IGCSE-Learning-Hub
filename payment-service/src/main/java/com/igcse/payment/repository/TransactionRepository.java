...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
        ...
        /**
         * Tìm theo referenceId và loại giao dịch (để update transaction hiện có)
         */
        java.util.Optional<Transaction> findByReferenceIdAndTransactionType(Long referenceId, String transactionType);
