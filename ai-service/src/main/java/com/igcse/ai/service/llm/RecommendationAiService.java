...
public interface RecommendationAiService {
  ...
  @UserMessage("""
      ...
      AVAILABLE PLATFORM COURSES (Prioritize these in recommendations):
      {{availableCourses}}

      Language: {{language}}

      Generate the personalized learning recommendation report now.
      Use the Persona data to tailor your tone.
      CRITICAL: You MUST map student weaknesses to specific courses from the "AVAILABLE PLATFORM COURSES" list above if they match.
  ...
  LearningRecommendationDTO generateRecommendation(
      ...
      @V("availableCourses") String availableCourses,
