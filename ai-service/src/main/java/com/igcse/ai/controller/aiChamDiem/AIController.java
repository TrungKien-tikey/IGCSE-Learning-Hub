...
import com.igcse.ai.dto.xuLyBatch.BatchGradingRequest;
...
import com.igcse.ai.service.aiChamDiem.BatchGradingService;
...
public class AIController {
    ...
    public ResponseEntity<com.igcse.ai.dto.aiChamDiem.DetailedGradingResultDTO> getDetailedResult(
            @PathVariable Long attemptId) {
        logger.info("Get detailed result request - attemptId: {}", attemptId);

        com.igcse.ai.dto.aiChamDiem.DetailedGradingResultDTO result = aiService.getDetailedResult(attemptId);
