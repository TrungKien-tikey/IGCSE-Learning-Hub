...
export default function EditExamPage() {
  ...
  // Thông tin chung (Đã thêm maxAttempts)
    ...
    fetch(`http://localhost:8080/api/exams/${examId}`)
      ...
      .then((data) => {
        setExamInfo({
          ...
          maxAttempts: data.maxAttempts || 1, // <--- Map dữ liệu từ API
  ...
  if (dataLoading)
    return <div className="text-center p-10">Đang tải dữ liệu bài thi...</div>;
