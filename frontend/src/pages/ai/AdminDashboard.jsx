        ...
        <div className="min-h-screen bg-slate-50 p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-10 flex justify-between items-center">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Hệ thống Quản trị AI</h1>
                        <p className="text-slate-500 mt-1">Giám sát tài nguyên, hiệu suất và độ chính xác của mô hình</p>
                    </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                                ...
                                <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                                    <div className="flex justify-between items-center mb-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="font-bold text-slate-700">Bộ máy chấm điểm AI</span>
                                        </div>
                                        <span className="text-[10px] font-bold bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded uppercase font-mono tracking-tighter">Trực tuyến</span>
                                    </div>
                                    <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
                                        <div className="h-full bg-indigo-500 w-[65%] shadow-sm" />
                                    </div>
                                    <p className="text-[10px] text-slate-400 mt-2 font-medium italic">Tải: 65% • Độ trễ: 240ms</p>
                                </div>
                                ...
                                <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                                    <div className="flex justify-between items-center mb-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="font-bold text-slate-700">Cơ sở dữ liệu Phân tích</span>
                                        </div>
                                        <span className="text-[10px] font-bold bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded uppercase font-mono tracking-tighter">Trực tuyến</span>
                                    </div>
                                    <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
                                    ...
                                    <p className="text-[10px] text-slate-400 mt-2 font-medium italic">Sử dụng: 42% • 1.2M Bản ghi</p>
                                </div>
                            </div>

                            <div className="pt-6 border-t border-slate-100">
                                <h3 className="font-bold text-slate-800 mb-4">Nhật ký hệ thống gần đây</h3>
                                <div className="space-y-3 font-mono text-[11px] bg-slate-50 p-4 rounded-xl border border-slate-100">
                    ...
                    {/* AI Model Summary */}
                    <div className="bg-gradient-to-br from-indigo-900 to-slate-900 p-8 rounded-3xl text-white shadow-xl flex flex-col justify-between">
                        <div>
                            <h2 className="text-xl font-bold mb-6">Mô hình AI hiện tại</h2>
                            <div className="bg-white bg-opacity-10 p-4 rounded-2xl border border-white border-opacity-10 mb-6">
                                <p className="text-xs text-indigo-200 mb-1">Provider</p>
                                <p className="font-bold">LangChain4j / OpenAI GPT-4o</p>
                            </div>
